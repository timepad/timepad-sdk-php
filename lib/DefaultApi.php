...
class DefaultApi {
   ...
   * @param array[string] $access_statuses Список режимов доступа, в которых находятся события. Возможные значения: draft, link_only, public. Доступно только организаторам (required)
