...
class Link implements ArrayAccess {
    ...
    /**
    * Машиночитаемое описание ссылки (для оплат - строковый идентификатор платёжной системы)
    *
    * @var string
    */
    public $name;
    /**
    * Человекочитаемое описание ссылки (для оплат - название платёжной системы)
    *
    * @var string
    */
    public $title;
